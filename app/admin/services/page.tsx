        ...
        s.id === deleteFeatureModal.serviceId
          ? {
              ...
              features: s.features.filter(
                (f) => f.id !== deleteFeatureModal.featureId
              ),
            }
          : s
      )
    ...
    setServices((prev) =>
      prev.map((s) =>
        s.id === deleteSubModal.serviceId
          ? {
              ...s,
              subServices: s.subServices.filter(
                (sub) => sub.id !== deleteSubModal.subServiceId
              ),
            }
          : s
      )
                    ...
                    {expandedServices.has(service.id) && (
                      <div className="mt-4 border-t pt-4 space-y-6">
                        ...
                        {service.subServices.map((sub) => (
                          <div
                            key={sub.id}
                            className="bg-blue-50 border rounded-lg p-3 mb-2"
                          >
                            <div className="flex justify-between items-start">
                              <div>
                            ...
                            <div className="mt-3 pl-4">
                              <div className="flex justify-between items-center mb-1">
                                ...
                                <Link
                                  href={`/admin/services/${service.id}/work/add?sub=${sub.id}`}
                                  className="bg-blue-100 text-blue-700 px-2 py-1 rounded-lg flex items-center text-xs hover:bg-blue-200"
                                >
                                ...
                                <ul className="list-disc list-inside text-gray-600 text-sm space-y-1">
                                  {sub.works.map((w) => (
                                    ...
                                    >
                                      ...
                                      <div className="flex gap-2">
                                        <Link
                                          href={`/admin/services/${sub.id}/work/add?edit=${w.id}`}
                                          className="p-1 text-blue-500 hover:text-blue-700 rounded-lg hover:bg-blue-50"
                                        >
                        ...
                        {service.features.length > 0 ? (
                          <ul className="space-y-2">
                            {service.features.map((f) => (
                              <li
                                key={f.id}
                                className="flex justify-between items-start bg-gray-50 p-3 rounded-lg border hover:border-blue-300 transition"
                              >
                                <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-3 py-1 flex items-center gap-1 border rounded-lg disabled:opacity-50 hover:bg-gray-100"
                    >
